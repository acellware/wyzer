...
export class ReportsController {
 ...
 @UseGuards(JwtAuthGuard)
 @ApiOperation({
  summary: "List reports for the caller's organisation (cursor-paginated)",
 })
 @ApiQuery({
  name: 'cursor',
  required: false,
  description: 'Report id to start after',
 })
 @ApiQuery({
  name: 'take',
  required: false,
 ...
 requestPdf(@CurrentUser('orgId') orgId: string, @Param('id') id: string) {
